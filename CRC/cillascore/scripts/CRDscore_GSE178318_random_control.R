...
# --- 配置 ---
WORK_DIR <- '/mnt/disk1/qiuzerui/downloads/CRC/cillascore/GSE178318'
...
cli <- read.csv('/mnt/disk1/qiuzerui/downloads/CRC/GSE178318/GSE178318_Cli.csv', header = TRUE, check.names = FALSE)
rt <- merge(meta, cli, by.x = "orig.ident", by.y = "Patient ID")
rt$group <- ifelse(rt$type == "CRC", "Primary", "Metastasis")
