...
# --- 配置 ---
WORK_DIR <- '/mnt/disk1/qiuzerui/downloads/CRC/cillascore/GSE231559'
...
# --- 读取 Seurat 对象 ---
pbmc1 <- qread('/mnt/disk1/qiuzerui/downloads/CRC/GSE231559/Malignant_RNA_assay.qs')
...
cli <- read.csv('/mnt/disk1/qiuzerui/downloads/CRC/GSE231559/GSE231559_Cli.csv', header = TRUE, check.names = FALSE)
rt <- merge(meta, cli, by = "Patient")
rt$group <- ifelse(grepl("metasta|Metasta", rt[['metastasis']], ignore.case = TRUE), "Metastasis", "Primary")
