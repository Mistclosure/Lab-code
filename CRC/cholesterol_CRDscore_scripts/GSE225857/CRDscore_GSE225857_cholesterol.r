...
PLOTS_DIR <- "/mnt/disk1/qiuzerui/downloads/CRC/cholesterol_Score/GSE225857"
...
# --- 绘图公共参数设置 ---
type_group = levels(factor(rt1$"Liver metastasis (LM)"))
my_comparisons = list()
...
# ==================== 绘图 1: CRDscore ====================
data_p = rt1[,c('score','Liver metastasis (LM)')]
...
print(p)
ggsave(file.path(PLOTS_DIR, paste0(file_base_name, "_GSE225857_CRDscore.png")), plot = p, width = 7, height = 6, dpi = 300)
