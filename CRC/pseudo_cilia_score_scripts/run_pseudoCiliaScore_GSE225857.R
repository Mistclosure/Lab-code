...
OUT_ROOT <- "/mnt/disk1/qiuzerui/downloads/CRC/pseudo_cilia_score_results/GSE225857"
...
cli <- read.csv("GSE225857_Cli.csv", header = TRUE, check.names = FALSE)
...
obj$metastasis <- ifelse(obj@meta.data[["Liver metastasis (LM)"]] == "Yes", "metastasis", "primary")
