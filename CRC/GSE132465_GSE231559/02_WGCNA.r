...
malig_seurat <- qread("/mnt/disk1/qiuzerui/downloads/CRC/GSE132465_GSE231559/Merged_malig.qs")
...
ciliahub_genes <- read.csv("ciliahub_genes_list.csv", header = TRUE, check.names = FALSE, row.names = 1)
